...
def main():
    ...
    parser.add_argument('--enable_carrier_regularization', action='store_true', default=None)
    parser.add_argument('--lambda_sparse', type=float, default=None)
    parser.add_argument('--lambda_bg', type=float, default=None)
    parser.add_argument('--lambda_floor', type=float, default=None)
    parser.add_argument('--lambda_sem', type=float, default=None)
    parser.add_argument('--residual_floor_tau', type=float, default=None)
    parser.add_argument('--freeze_bitencoder', action='store_true', default=None)
    parser.add_argument('--freeze_bitdecoder', action='store_true', default=None)
    parser.add_argument('--freeze_copyright_branch', action='store_true', default=None)
    parser.add_argument('--return_fragile_carrier', action='store_true', default=None)
    parser.add_argument('--semantic_map_dir', type=str, default=None)
    args = parser.parse_args()
    opt = option.parse(args.opt, is_train=True)
    stage5_overrides = {
        'enable_carrier_regularization': args.enable_carrier_regularization,
        ...
        'freeze_bitencoder': args.freeze_bitencoder,
        'freeze_bitdecoder': args.freeze_bitdecoder,
        'freeze_copyright_branch': args.freeze_copyright_branch,
        'return_fragile_carrier': args.return_fragile_carrier,
        'semantic_map_dir': args.semantic_map_dir,
    }
    for key, value in stage5_overrides.items():
